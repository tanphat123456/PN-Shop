                ...
                <div class="thank-box " style="padding: 0px;">
                    ...
                    <div style="display: flex; align-items: center;">
                        ...
                        <div class="order-date" style="white-space: nowrap; margin-left: auto; margin-right: 0;">
                            Ngày đặt: {{ $details['data']['created_at'] }}
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>
                                {{ number_format($details['data']['total_amount'], 0, ',', '.') }} VNĐ                               
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4">
                    ...
                    <div class="box text--left">
                        ...
                        <p>Địa chỉ Email:
                            <span class="text--bold">
                                {{ $details['data']['user_email'] }}
                            </span>
                        </p>
                        <p>Số điện thoại:
                            <span class="text--bold">
                                {{ $details['data']['user_phone'] }}
                            </span>
                        </p>
